...
const View = ({ checkedValue, onChange }) => {
    return (
        <div className='view-icons viewRadioGroup' onChange={onChange}>
            <div className='list'>
                <input type="radio" id="view-list" name="selector" value="list" defaultChecked={checkedValue === 'list'} />
                <label htmlFor="view-list"><MdViewList /></label>
            </div>
            <div className='grid'>
                <input type="radio" id="view-grid" name="selector" value="grid" defaultChecked={checkedValue === 'grid'}/>
                <label htmlFor="view-grid"><MdViewModule /></label>
            </div>
            <div className='column'>
                <input type="radio" id="view-column" name="selector" value="column" defaultChecked={checkedValue === 'column'} />
